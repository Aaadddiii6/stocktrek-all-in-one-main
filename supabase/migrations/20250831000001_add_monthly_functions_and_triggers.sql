-- Add the missing functions and triggers for monthly expenses summary
-- This completes the monthly tracking system

-- 1. Enable RLS on the monthly_expenses_summary table
...
-- 3. Create function to calculate monthly summary from daily expenses
...
-- 4. Create function to upsert monthly summary
...
-- 5. Create trigger to automatically update monthly summary when daily expenses change
...
-- 7. Create function to get available months for dropdown
...
-- 8. Create function to initialize current month if it doesn't exist
...
-- 9. Populate existing data into monthly_expenses_summary
