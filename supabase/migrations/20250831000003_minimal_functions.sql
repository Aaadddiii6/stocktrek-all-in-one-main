-- Minimal migration - only add missing functions and populate data
...
-- 3. Create function to get available months for dropdown
...
-- 4. Create function to initialize current month if it doesn't exist
...
-- 5. Populate existing data into monthly_expenses_summary
