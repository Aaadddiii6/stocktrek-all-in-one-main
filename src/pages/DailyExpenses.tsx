...
import { AddExpenseRecordModal } from '@/components/AddExpenseRecordModal';
  ...
  const fetchExpenseStats = async () => {
    try {
      ...
      if (expenses && expenses.length > 0) {
        ...
        const totalExpenses = expenses.reduce((sum, expense) => sum + Number(expense.expenses), 0);
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-muted-foreground">Track daily operational expenses</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className={`text-2xl font-bold ${stats.remainingBalance < 0 ? 'text-destructive' : 'text-green-600'}`}>
        ...
        {/* Activity Logs */}
        <ModuleActivityLogs moduleType="daily_expenses" moduleName="Daily Expenses" />
      </div>

      {/* Add Record Modal */}
      <AddExpenseRecordModal
        open={isAddModalOpen}
